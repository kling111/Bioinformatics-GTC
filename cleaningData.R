...
library(readxl)
Pool_1_CDR3_Results <- read_excel("~/Downloads/Chapes files/Pool 1 - CDR3 Results.xlsx", col_names = FALSE)
View(Pool_1_CDR3_Results) #Hello, Ms, Jacci, all you need to do is change these three lines of code right here.
